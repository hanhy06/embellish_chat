...
* `EVERYONE`: Mentions **all players** on the server. **Option:** `None`
* `INSIDE`: Mentions players **within a specific radius** of the sender in the same world. **Option:** `Radius`
* `TEAM`: Mentions **all players in the specified scoreboard team**. **Option:** `Team Name`
