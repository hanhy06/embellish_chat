...
| `COMMAND_RUN`     | Runs the command supplied via the option when the text is clicked.                                                                                               | command                 |
| `COMMAND_SUGGEST` | Suggests the command supplied via the option when the text is clicked. The suggested command is placed into the chat input field but not executed automatically. | command                 |
| `HOVER`           | Displays the text supplied via the option when the mouse hovers over it.                                                                                         | text                    |
