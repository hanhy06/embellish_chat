...
| `SHOW_ITEM`             | Displays the description along with the texture of the item and block currently held by the player.                                                              | Absolute path of the atlas: `namespace:path` |
