...
| `CLICK_OPEN_INVENTORY`  | Displays the user’s face. Clicking it shows the user’s inventory at the time the message was sent.                                                               | No options are required          |
...
| `PREFIX`                | Attach the translation option before the text.                                                                                                                   | text                             |
| `SUFFIX`                | Attach the translation option after the text.                                                                                                                    | text                             |
