...
public class StyleRegistry {
    ...
    public MutableText REPLACE(StyleParameter parameter) {
        return Text.literal(parameter.option()).fillStyle(parameter.segment().getStyle());
    }

    public MutableText MASK(StyleParameter parameter) {
        int length = parameter.segment().getString().length();
        return Text.literal(parameter.option().repeat(length)).fillStyle(parameter.segment().getStyle());
    }
