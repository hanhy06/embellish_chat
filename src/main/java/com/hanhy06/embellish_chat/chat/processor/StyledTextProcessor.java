...
public class StyledTextProcessor {
    ...
    private Identifier defaultChatFont = null;
    ...
    public void updateConfig(Config config) {
        ...
        if (!config.defaultChatFont().isEmpty()){
            this.defaultChatFont = Identifier.tryParse(config.defaultChatFont());
        }else {
    ...
    private MutableText applyFont(MutableText text, String strFont) {
        return text.fillStyle(Style.EMPTY.withFont(Identifier.tryParse(strFont)));
    }
